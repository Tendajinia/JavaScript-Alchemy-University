...
/*
Then and Catch
Build the promise library: Pact

Task
Add the Methods
Your first task is to create two class methods catch and then. 
These methods are used by promises to wire up callbacks.
...
Similarly, if the reject function is
 invoked the catch function will be invoked with the value passed into reject!
*/
